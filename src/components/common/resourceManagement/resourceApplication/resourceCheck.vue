               ...
               <div class="allcontent">
                        ...
                        <div class="container clearfix">
                            ...
                            <div class="container-right">
                                <div>
                                    <span>所属部署单元：</span>
                                    <Input style="width: 180px" v-model="jsonname.project"  disabled ></Input>
                            ...
                            <Tabs>
                                <Tab-pane label="MYSQL" name="mysql">
                                    <div class="container-left" >
                                        ...
                                        <div style="height: 50px" >
                                            <span>存储空间：</span>
                                            <Input-number v-model="jsonname.resource_list[0].disk" disabled></Input-number>G
                                        </div>
                                    </div>
                                    <div class="container-right">
                                        <div style="height: 50px">
    ...
    export default {
       ...
       if(this.$route.query.id){
           ...
           this.$http.get(url,{emulateJSON: true}).then(function (response) {
               ...
               if(response.body.code===200 && response.body.result.res=="success") {
                this.jsonname= response.body.result.msg
                   this. arrToString();
                   console.log("last"+this.jsonname)
               }
               // 成功回调
           });
       }
        ...
        arrToString(){
            ...
            //将开发环境改成中文
            if(this.jsonname.env == "develop"){
                this.jsonname.env="开发环境"
            }
                if(this.jsonname.env == "test"){
                    this.jsonname.env="测试环境"
                }
                if(this.jsonname.env == "product"){
                    this.jsonname.env="生产环境"
                }
        },
        pass() {
            let self=this;
