  ...
  <div class="inquire">
    ...
    <div class="inquire-table">
      ...
      <div class="inquire-table-page">
        <Page :total="data_length" show-sizer @on-change="changePage" @on-page-size-change="page_size_change"
              :current="current_page" :page-size="page_size"></Page>
      </div>
    </div>
  </div>
</template>
    ...
    methods: {
      goQuery () {
        ...
        if (this.userInfo.role === 'admin'){
          ...
          requestBody.user_id = this.userInfo.id;
        }
