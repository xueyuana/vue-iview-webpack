      ...
      <Form :model="formValidate" ref="formValidate" :rules="ruleValidate" :label-width="90">
        <div class="form-wrap">
          ...
          <Form-item label="部署实例名称:" prop="instance_name" class="form-item">
            <Select clearable v-model="formValidate.instance_name" style="width:250px">
              <Option v-for="item in instance" :value="item.instance_name" :key="item">{{ item.instance_name }}</Option>
            </Select>
          </Form-item>
        </div>
